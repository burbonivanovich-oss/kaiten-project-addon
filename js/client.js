...
const DEFAULTS = {
  // id аккаунта artempdirect1.kaiten.ru (сверено с живым API 2026-07-24).
  project_type_ids: [699509],   // тип «Проект»
  goal_type_ids: [699506],      // тип «Цель»
  direction_type_ids: [699508], // тип «Направление»
  task_type_ids: [699507],      // тип «Задача»
  hypothesis_type_ids: [699510], // тип «Гипотеза»
  new_project_board_id: 1841475, // доска «Проекты» (портфель, в «2 · Направления») — форма
                                 // кладёт проекты сюда; null = доска карточки
  functions_space_id: 819167,   // пространство «3 · Работа команд» — доски-функцзоны
