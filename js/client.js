...
var initResult = Addon.initialize({
  ...
  card_facade_badges: async (ctx) => {
     ...
     * кодом нельзя. Причина в установке аддона, а не здесь.
     * Цвета всё равно приведены к enum (green/red/orange) — так требует
     * документация, и на hex бейджи не появились бы и после починки установки. */
    try {
